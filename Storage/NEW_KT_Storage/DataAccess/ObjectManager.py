...
import json
import sqlite3
from KT_Cloud.DB.NEW_KT_DB.DataAccess.ObjectManager import ObjectManager as DBObjectManager
...
class ObjectManager:
    def __init__(self, db_file: str,type, storage_path=None):
        ...
        self.object_manager = DBObjectManager(db_file)
        self.storage_manager = StorageManager(storage_path)
        self.object_name = type

    # for outer use:
    def save_in_memory(self, object, name):
        ...
        table_name = self.object_manager.convert_object_name_to_management_table_name(name)
    ...
    def delete_from_memory(self,object, name, criteria='default'):
    ...
    def update_in_memory(self,object,name, updates, criteria='default'):
