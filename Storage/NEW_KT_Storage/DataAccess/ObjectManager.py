...
from DB.NEW_KT_DB.DataAccess.ObjectManager import ObjectManager as DB_ObjectManager
...
class ObjectManager:
    ...
    def __init__(self, db_file: str, type, storage_path=None):
        ...
        self.object_manager = DB_ObjectManager(db_file)
    ...
    def save_in_memory(self, object):
        ...
        table_name = self.object_manager.convert_object_name_to_management_table_name(
            self.object_name
        )
    ...
    def update_in_memory(self, object, updates, criteria="default"):
        ...
        self.object_manager.update_object_in_management_table_by_criteria(
