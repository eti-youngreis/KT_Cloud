...
class BucketObjectManager:
    ...
    def create_table(self):
        ...
        self.object_manager.object_manager.db_manager.create_table("mng_Objects", columns_str)
    ...
    def deleteInMemoryBucketObject(self, bucket_name, object_name):
        ...
        pk_column = "object_id"
        self.object_manager.delete_from_memory_by_pk(self.object_name, pk_column, obj_id)

    def describeBucketObject(self, object_id):
        return self.object_manager.get_from_memory(self.object_name, criteria=f"object_id = '{object_id}'")
