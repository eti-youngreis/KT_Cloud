...
def load_employee_sales_and_interactions():
    # Initialize Spark session
    spark = SparkSession.builder \
        .appName("Employee Sales Performance and Customer Interactions") \
        .getOrCreate()
    ...
    try:
        # Join Employees with Customers they support
...
if __name__ == "__main__":
    load_employee_sales_and_interactions()
