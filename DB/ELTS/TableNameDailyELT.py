...
def incremental_elt():
    ...
    try:
        ...
        KT_DB.insert_dataframe(conn, 'raw_related_table_1', related_table_1_df, mode='append')
        KT_DB.insert_dataframe(conn, 'raw_related_table_2', related_table_2_df, mode='append')
