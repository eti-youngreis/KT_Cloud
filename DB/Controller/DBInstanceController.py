...
class DBinstanceController:
    ...
    def create_db_instance(self, db_instance_identifier: str, allocated_storage: int = None, port: int = 3306, region: str = 'a',
        ...
        self.service.create(db_instance_identifier=db_instance_identifier, allocated_storage=allocated_storage, port=port, region=region, source_instance=source_instance,
