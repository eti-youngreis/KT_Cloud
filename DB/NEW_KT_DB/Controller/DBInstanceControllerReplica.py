...
class DBInstanceController:
    ...
    def restore_version(self, db_instance_identifier, db_snapshot_identifier):
        return self.service.restore_version_snapshot(db_instance_identifier, db_snapshot_identifier)
    
    def create_db_instance_read_replica(self,**kwargs):
        return self.service.create_raed_replica(**kwargs)
    
    def switchover_read_replica(self,db_instance_identifier):
        return self.service.switchover_read_replica(db_instance_identifier)
    
    def promote_read_replica(self,db_instance_identifier):
        return self.service.promote_read_replica(db_instance_identifier)
