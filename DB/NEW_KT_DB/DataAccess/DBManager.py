...
class DBManager:
    ...
    def create_table(self, table_name, table_structure):
        ...
        """create a table in a given db by given table_structure"""
        create_statement = (
            f"""CREATE TABLE IF NOT EXISTS {table_name} ({table_structure})"""
        )
        self.execute_query_without_results(create_statement)
    ...
    def update_records_in_table(
        self, table_name: str, updates: Dict[str, Any], criteria: str
    ) -> None:
        """Update records in the specified table based on criteria."""
    ...
    def select_and_return_records_from_table(
        self, table_name: str, columns: List[str] = ["*"], criteria: str = ""
