...
class DBClusterManager:
    ...
    def is_db_cluster_exist(self, db_cluster_identifier: int) -> bool:
        """
        Check if a DBCluster with the given identifier exists in memory.

        Params: db_cluster_identifier: The primary key (ID) of the DBCluster to check.
        
        Return: True if the DBCluster exists, otherwise False.
        """
