...
class ObjectManager:
    ...
    def create_management_table_with_str_id(self, table_name, table_structure='object_id TEXT NOT NULL PRIMARY KEY ,type_object TEXT NOT NULL,metadata TEXT NOT NULL')
        self.db_manager.create_table(table_name, table_structure)
