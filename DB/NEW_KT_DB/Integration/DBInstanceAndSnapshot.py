...
print(f"{RED}{start_creation_date_time} going to create db DBInstance names 'exampleDbInstance'{RESET}")
...
print(f"{RED}Total creation time: {end_creation_date_time - start_creation_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Describe DBInstance----------------------{RESET}")
start_description_date_time = datetime.now()
print(f"{RED}{start_description_date_time} going to describe db DBInstance 'exampleDbInstance'{RESET}")
...
print(f"{RED}Total description time: {end_description_date_time - start_description_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Modify DBInstance----------------------{RESET}")
start_modification_date_time = datetime.now()
print(f"{RED}{start_modification_date_time} going to modify db DBInstance 'exampleDbInstance'{RESET}")
...
print(f"{RED}Total modification time: {end_modification_date_time - start_modification_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Describe Modified DBInstance----------------------{RESET}")
start_description_date_time = datetime.now()
print(f"{RED}{start_description_date_time} going to describe db DBInstance 'exampleDbInstance' after modification{RESET}")
description = db_instance_controller.describe_db_instance(db_instance_identifier='exampleDbInstance')
...
print(f"{RED}{start_creation_database_date_time} going to create db 'exampledb' in DBInstance 'exampleDbInstance'{RESET}")
...
print(f"{RED}Total creation database time: {end_creation_database_date_time - start_creation_database_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Create Table----------------------{RESET}")
start_creation_table_date_time = datetime.now()
print(f"{RED}{start_creation_table_date_time} going to create table 'exampleTable' in DBInstance 'exampleDbInstance' in database 'exampledb'{RESET}")
...
print(f"{RED}Total creation table time: {end_creation_table_date_time - start_creation_table_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Insert Data----------------------{RESET}")
start_insert_data_date_time = datetime.now()
print(f"{RED}{start_insert_data_date_time} going to insert data in DBInstance 'exampleDbInstance' in database 'exampledb'{RESET}")
db_instance_controller.execute_query(db_instance_identifier='exampleDbInstance',
...
print(f"{RED}Total insert data time: {end_insert_data_date_time - start_insert_data_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Select Data----------------------{RESET}")
start_select_data_date_time = datetime.now()
print(f"{RED}{start_select_data_date_time} going to select data in DBInstance 'exampleDbInstance' in database 'exampledb'{RESET}")
...
print(f"{RED}Total select data time: {end_select_data_date_time - start_select_data_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Create Snapshot----------------------{RESET}")
start_creation_snapshot_date_time = datetime.now()
print(f"{RED}{start_creation_snapshot_date_time} going to create db DBInstance snapshot 'example_snapshot_1'{RESET}")
...
print(f"{RED}Total creation snapshot time: {end_creation_snapshot_date_time - start_creation_snapshot_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Delete Record----------------------{RESET}")
start_delete_record_date_time = datetime.now()
print(f"{RED}{start_delete_record_date_time} going to delete one record in DBInstance 'exampleDbInstance' in database 'exampledb'{RESET}")
db_instance_controller.execute_query(db_instance_identifier='exampleDbInstance',
...
print(f"{RED}Total delete record time: {end_delete_record_date_time - start_delete_record_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Select After Delete----------------------{RESET}")
start_select_data_date_time = datetime.now()
print(f"{RED}{start_select_data_date_time} Check that the data has been successfully deleted in table exampleTable in Snapshot example_snapshot_1{RESET}")
results = db_instance_controller.execute_query(db_instance_identifier='exampleDbInstance', query='SELECT * FROM exampleTable', db_name="exampledb")
end_select_data_date_time = datetime.now()
print(f"\nresults of the select query: {results}\n")
print(f"{GREEN}{end_select_data_date_time} DBInstance 'exampleDbInstance' data selected successfully{RESET}")
...
start_creation_snapshot_date_time = datetime.now()
print(f"{RED}{start_creation_snapshot_date_time} going to create db DBInstance snapshot 'example_snapshot_2'{RESET}")
...
print(f"{RED}{start_restore_snapshot_date_time} going to restore db DBInstance 'exampleDbInstance' from snapshot 'example_snapshot_1'{RESET}")
...
print(f"{RED}Total restore snapshot time: {end_restore_snapshot_date_time - start_restore_snapshot_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Select After Restore----------------------{RESET}")
start_select_data_date_time = datetime.now()
print(f"{RED}{start_select_data_date_time} Checking that the data exists in the Snapshot to which we restored, Snapshot example_snapshot_1{RESET}")
results = db_instance_controller.execute_query(db_instance_identifier='exampleDbInstance', query='SELECT * FROM exampleTable', db_name="exampledb")
end_select_data_date_time = datetime.now()
print(f"\nresults of the select query: {results}\n")
print(f"{GREEN}{end_select_data_date_time} DBInstance 'exampleDbInstance' data selected successfully{RESET}")
...
print(f"{RED}{start_deletion_snapshot_date_time} going to delete db DBInstance snapshot 'example_snapshot_2'{RESET}")
...
print(f"{RED}Total deletion snapshot time: {end_creation_snapshot_date_time - start_deletion_snapshot_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------List Snapshots----------------------{RESET}")
start_list_snapshots_date_time = datetime.now()
print(f"{RED}{start_list_snapshots_date_time} going to list db DBInstance 'exampleDbInstance' snapshots{RESET}")
...
print(f"{RED}Total list snapshots time: {end_list_snapshots_date_time - start_list_snapshots_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Delete Another Snapshot----------------------{RESET}")
start_deletion_snapshot_date_time = datetime.now()
print(f"{RED}{start_deletion_snapshot_date_time} going to delete db DBInstance 'exampleDbInstance' snapshot 'example_snapshot_1'{RESET}")
...
print(f"{RED}Total deletion snapshot time: {end_deletion_snapshot_date_time - start_deletion_snapshot_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Delete DBInstance----------------------{RESET}")
start_deletion_date_time = datetime.now()
print(f"{RED}{start_deletion_date_time} going to delete db DBInstance 'exampleDbInstance'{RESET}")
...
print(f"{RED}Total deletion time: {end_deletion_date_time - start_deletion_date_time}{RESET}")
time.sleep(2)

print(f"\n{BLUE}---------------------Attempt to Get Deleted DBInstance----------------------{RESET}")
start_get_deleted_instance_time = datetime.now()
print(f"{RED}{start_get_deleted_instance_time} Attempting to get deleted DBInstance 'exampleDbInstance'{RESET}\n")
try:
...
print(f"\n{RED}Total attempt time: {end_get_deleted_instance_time - start_get_deleted_instance_time}{RESET}")
time.sleep(2)
