...
print(Fore.CYAN + '''---------------------Start Of session----------------------''')
start_current_time = datetime.now()
formatted_time = start_current_time.strftime("%Y-%m-%d %H:%M:%S")
print(Fore.CYAN +f'''{formatted_time} demonstration of object Cluster start''')
...
print(Fore.GREEN + f'''{start_date_time} going to create db cluster names "example"''')
cluster_data = {
...
print(Fore.GREEN + f'''{end_date_time} cluster "example" created successfully''')
print(f"Total creation time: {end_date_time - start_date_time}")
time.sleep(4)

print(Fore.BLUE + "\n---------------------Describe DBCluster----------------------")
start_date_time = datetime.now()
print(Fore.GREEN + f'''{start_date_time} going to describe db cluster names "example"''')
description = clusterController.describe_db_cluster('example')
print(Fore.WHITE +f"\nDB cluster 'example' description: {description}\n")
end_date_time = datetime.now()
print(Fore.GREEN +f"{end_date_time} DBCluster 'example' described successfully")
print(f"Total description time: {end_date_time - start_date_time}")
time.sleep(4)

print(Fore.BLUE + "\n---------------------Modify DBCluster----------------------")
start_date_time = datetime.now()
print(Fore.GREEN + f'''{start_date_time} going to modify db cluster names "example"''')
update_data = {
    'engine': 'postgres',
    'allocated_storage':3,
    }
...
end_date_time = datetime.now()
print(Fore.GREEN +f"{end_date_time} DBCluster 'example' modified successfully")
...
print(Fore.BLUE + "\n---------------------Delete DBCluster----------------------")
start_date_time = datetime.now()
print(Fore.GREEN + f'''{start_date_time} going to delete db cluster names "example"''')
clusterController.delete_db_cluster('example')
end_date_time = datetime.now()
print(Fore.GREEN +f"{end_date_time} DBCluster 'example' deleted successfully")
print(f"Total deletion time: {end_date_time - start_date_time}")
time.sleep(4)

print(Fore.BLUE + "\n---------------------Attempt to Describe Deleted DBCluster----------------------")
start_date_time = datetime.now()
print(Fore.GREEN + f'''{start_date_time} going to attempt description of deleted db cluster names "example"\n''')
try:
    description = clusterController.describe_db_cluster('example')
...
print(Fore.CYAN + '''---------------------End Of session----------------------''')
