...
"""
import pytest
from DB.NEW_KT_DB.Validation.DBInstanceNaiveValidition import MissingRequireParamError

class TestDBInstanceController:

    @pytest.fixture(autouse=True)
    def setup_db_instance(self, db_instance_controller):
        instance = db_instance_controller.create_db_instance(master_user_password='123456',master_username='admin',db_instance_identifier="test-instance", allocated_storage=10)
        yield instance
    ...
    def test_create_db_instance_invalid_input(self, db_instance_controller):
        with pytest.raises((ValueError,MissingRequireParamError)):
