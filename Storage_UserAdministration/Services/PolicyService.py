...
class PolicyService:
    ...
    def create(self, policy_name, version, permissions):
        """Create a new policy."""
        ...
        policy = PolicyModel(policy_name, version, permissions)
    ...
    def update(self, policy_name: str, version: str, permissions: list) -> PolicyModel:
        ...
        updated_policy = PolicyModel(policy_name, version, permissions)
